  ...
  return (
    <div className="container about-page">
      <div className="text-zone">
        ...
        <p>
          Hi! 👋 I'm a professional Frontend Developer in web programming,
          focused on finding solutions to digital problems.
        </p>
        <p>
          I have experience in the SERN stack (Sequelize | Express | React |
          Node). With a focus on the Frontend, I specialize in creating web
          applications centered around user interfaces with modern, attractive,
          and dynamic designs, creating unique experiences.
        </p>
        <p>
          I have organizational skills, am empathetic, and resilient, and I
